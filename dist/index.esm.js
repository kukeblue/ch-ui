...
function ChDatePicker(props) {
  var value = props.value ? hooks(props.value) : null;
  return /*#__PURE__*/ React.createElement(DatePicker, {
    ...
    onChange: function onChange(date, dateStr) {
      return props.onChange && props.onChange(dateStr);
    },
  });
}
...
var ChForm = function(_ref) {
  ...
  var renderFormItem = function renderFormItem(item) {
    ...
    switch (item.type) {
      ...
      case 'password':
        dom = /*#__PURE__*/ React.createElement(Input.Password, {
          placeholder: item.placeholder,
          iconRender: function iconRender(visible) {
            return visible
              ? /*#__PURE__*/ React.createElement(EyeTwoTone, null)
      ...
      case 'date':
        dom = /*#__PURE__*/ React.createElement(ChDatePicker, {
...
var chTablePanel = /*#__PURE__*/ forwardRef(function(props, ref) {
  ...
  var tablePage = ChUtils.chHooks.usePage({
    url: url,
    pageSize: 10,
    query: query || {},
    onReloadAfter: onReloadAfter,
  });
  var list = tablePage.list,
    reload = tablePage.reload,
    total = tablePage.total,
    status = tablePage.status,
    setQuery = tablePage.setQuery;
